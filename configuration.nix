...
let
  home-manager = builtins.fetchTarball {
    ...
    sha256 = "12mr1sr560lma7zr68yh7cwb4xd9n6n3gnbqr6p9qm55hl0hw24r";
  };
in

{
  ...
  services.xserver = {
     ...
     services.xserver.xkb = {
        layout = "us,ara";
        options = "grp:ctrl_alt_toggle";  # Right Ctrl+Alt = swap
    };
  ...
  # options = "grp:caps_switch,eurosign:e";  # caps_switch is more reliable
  ...
  hardware.bluetooth.powerOnBoot = true;  # Auto-powers on boot
